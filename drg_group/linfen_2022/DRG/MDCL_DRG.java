...
public class MDCL_DRG {
    ...
    public static boolean LB29_group(MedicalRecord record){
        return true;
    }
    ...
    public static boolean LS19_group(MedicalRecord record){
        return true;
    }

    public static boolean LT19_group(MedicalRecord record){
        return true;
    }
