...
public class MDCF_DRG {
    ...
    public static boolean FB11_group(MedicalRecord record){
    ...
    public static boolean FB13_group(MedicalRecord record){
    ...
    public static boolean FD33_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }
    ...
    public static boolean FP13_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }
    ...
    public static boolean FB15_group(MedicalRecord record){
        return true;
    }
    ...
    public static boolean FD35_group(MedicalRecord record){
        return true;
    }
