...
public class MDCP_DRG {
    ...
    public static boolean PB11_group(MedicalRecord record){
    ...
    public static boolean PB13_group(MedicalRecord record){
    ...
    public static boolean PB15_group(MedicalRecord record){
        return true;
    }
