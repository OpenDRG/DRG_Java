...
public class MDCV_DRG {
    ...
    public static boolean VB1A_group(MedicalRecord record){
    ...
    public static boolean VJ1B_group(MedicalRecord record){
        return true;
    }

    public static boolean VR1B_group(MedicalRecord record){
        return true;
    }

    public static boolean VS2B_group(MedicalRecord record){
        return true;
    }

    public static boolean VZ1B_group(MedicalRecord record){
        return true;
    }
