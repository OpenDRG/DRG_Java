...
public class MDCJ_DRG {
    ...
    public static boolean JA2B_group(MedicalRecord record){
        return true;
    }

    public static boolean JB1B_group(MedicalRecord record){
        return true;
    }

    public static boolean JS1B_group(MedicalRecord record){
        return true;
    }
