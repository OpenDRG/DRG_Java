...
public class MDCG_DRG {
    ...
    public static boolean GB1A_group(MedicalRecord record){
    ...
    public static boolean GE2A_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }
    ...
    public static boolean GG1B_group(MedicalRecord record){
        return true;
    }

    public static boolean GJ1B_group(MedicalRecord record){
        return true;
    }

    public static boolean GK2B_group(MedicalRecord record){
        return true;
    }
