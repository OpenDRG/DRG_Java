...
import drg_group.quanzhou_2023.DRG.MDCJ_DRG;
...
public class JA1_2 {
    public static String group(MedicalRecord record){
        ...
        if (true && Base.contains(adrg_zd,record.zdList[0]) && record.ssList.length>0 && Base.intersect(record.ssList,adrg_ss) && Base.intersect(record.ssList,adrg_ss1) && Base.intersect(record.ssList,adrg_ss2)){
