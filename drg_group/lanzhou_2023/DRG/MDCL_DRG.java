...
public class MDCL_DRG {
    ...
    public static boolean LB1A_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }

    public static boolean LE1A_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }

    public static boolean LJ1A_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }
    ...
    public static boolean LB2B_group(MedicalRecord record){
        return true;
    }

    public static boolean LF1B_group(MedicalRecord record){
        return true;
    }

    public static boolean LL1B_group(MedicalRecord record){
        return true;
    }
    ...
    public static boolean LT1B_group(MedicalRecord record){
        return true;
    }

    public static boolean LU1B_group(MedicalRecord record){
        return true;
    }

    public static boolean LV1B_group(MedicalRecord record){
        return true;
    }
