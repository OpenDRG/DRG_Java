...
public class MDCF_DRG {
    ...
    public static boolean FF1A_group(MedicalRecord record){
    ...
    public static boolean FM4A_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }
    ...
    public static boolean FD13_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }
    ...
    public static boolean FB2B_group(MedicalRecord record){
        return true;
    }

    public static boolean FC1B_group(MedicalRecord record){
        return true;
    }

    public static boolean FE2B_group(MedicalRecord record){
        return true;
    }

    public static boolean FP1B_group(MedicalRecord record){
        return true;
    }
    ...
    public static boolean FR2B_group(MedicalRecord record){
        return true;
    }

    public static boolean FT3B_group(MedicalRecord record){
        return true;
    }

    public static boolean FU1B_group(MedicalRecord record){
        return true;
    }

    public static boolean FV2B_group(MedicalRecord record){
        return true;
    }

    public static boolean FW1B_group(MedicalRecord record){
        return true;
    }

    public static boolean FZ1B_group(MedicalRecord record){
        return true;
    }
