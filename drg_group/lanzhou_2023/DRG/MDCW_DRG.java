...
public class MDCW_DRG {
    ...
    public static boolean WJ1B_group(MedicalRecord record){
        return true;
    }

    public static boolean WR1B_group(MedicalRecord record){
        return true;
    }

    public static boolean WZ1B_group(MedicalRecord record){
        return true;
    }
