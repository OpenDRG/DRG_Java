...
public class JA1 {
    public static String group(MedicalRecord record){
        String[] adrg_zd={"C50.902","C50.001","C50.804","C50.900","D05.900","D05.100","C50.900x005","C79.806","C50.800x005","C50.300","C50.100","D03.501","C50.800","D04.501","C79.200x007","C50.500","C50.801","C44.501","C50.400","C50.000","C50.000x001","C50.200","C50.803","C50.901","C50.600","C50.802","D05.000"};
        String[] adrg_zd1={};
