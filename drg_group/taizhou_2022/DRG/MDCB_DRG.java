...
public class MDCB_DRG {
    ...
    public static boolean BV10_group(MedicalRecord record){
    ...
    public static boolean BW19_group(MedicalRecord record){
        return true;
    }

    public static boolean BY19_group(MedicalRecord record){
        return true;
    }
    ...
    public static boolean BM19_group(MedicalRecord record){
        return true;
    }

    public static boolean BS19_group(MedicalRecord record){
        return true;
    }
    ...
    public static boolean BU23_group(MedicalRecord record){
        return record.zdList.length>1 && (Base.has_mcc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)) || Base.has_cc(record.Index,record.zdList[0],Arrays.copyOfRange(record.zdList,1,record.zdList.length)));
    }
    ...
    public static boolean BU25_group(MedicalRecord record){
        return true;
    }
