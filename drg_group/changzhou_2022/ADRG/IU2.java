...
public class IU2 {
    public static String group(MedicalRecord record){
        ...
        if (true && Base.contains(adrg_zd,record.zdList[0])){
            ...
            if (MDCI_DRG.IU27_group(record)){
                return "IU27";
            }
    
            if (MDCI_DRG.IU21_group(record)){
                return "IU21";
            }
