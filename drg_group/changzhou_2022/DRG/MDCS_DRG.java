...
public class MDCS_DRG {
    ...
    public static boolean SB10_group(MedicalRecord record){
    ...
    public static boolean SV19_group(MedicalRecord record){
        return true;
    }

    public static boolean SS17_group(MedicalRecord record){
