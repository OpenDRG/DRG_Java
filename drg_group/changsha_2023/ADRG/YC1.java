...
import drg_group.changsha_2023.DRG.MDCY_DRG;
...
public class YC1 {
    public static String group(MedicalRecord record){
        ...
        String[] adrg_ss1={};
        String[] adrg_ss2={};
        if (true && Base.intersect(record.zdList,adrg_zd) && record.ssList!=null && record.ssList.length>0 && Base.intersect(record.ssList,Base.SS_VALID)){
